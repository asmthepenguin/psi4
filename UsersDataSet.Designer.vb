...
Partial Public Class UsersDataSet
    ...
    Partial Public Class UtilizadoresDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddUtilizadoresRow(ByVal username As String, ByVal password As String, ByVal name As String, ByVal apelido As String) As UtilizadoresRow
            Dim rowUtilizadoresRow As UtilizadoresRow = CType(Me.NewRow,UtilizadoresRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, username, password, name, apelido}
        ...
        Private Sub InitClass()
            ...
            Me.columnapelido.AllowDBNull = false
    ...
    Partial Public Class UtilizadoresRow
        ...
        Public Property name() As String
            Get
                Return CType(Me(Me.tableUtilizadores.nameColumn),String)
            End Get
            Set
                Me(Me.tableUtilizadores.nameColumn) = value
            End Set
        End Property
...
Namespace UsersDataSetTableAdapters
    ...
    Partial Public Class UtilizadoresTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Utilizadores] WHERE (([Id] = @Original_Id) AND ([username] = @"& _ 
                "Original_username) AND ([password] = @Original_password) AND ([name] = @Original"& _ 
                "_name) AND ([apelido] = @Original_apelido))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Utilizadores] ([username], [password], [name], [apelido]) VALU"& _ 
                "ES (@username, @password, @name, @apelido);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, username, password, name"& _ 
                ", apelido FROM Utilizadores WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Utilizadores] SET [username] = @username, [password] = @password, ["& _ 
                "name] = @name, [apelido] = @apelido WHERE (([Id] = @Original_Id) AND ([username]"& _ 
                " = @Original_username) AND ([password] = @Original_password) AND ([name] = @Orig"& _ 
                "inal_name) AND ([apelido] = @Original_apelido));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, username, password,"& _ 
                " name, apelido FROM Utilizadores WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsAppLoginDB.My.MySettings.Default.UsersConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, username, password, name, apelido FROM dbo.Utilizadores"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_username As String, ByVal Original_password As String, ByVal Original_name As String, ByVal Original_apelido As String) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_apelido,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal username As String, ByVal password As String, ByVal name As String, ByVal apelido As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal username As String, ByVal password As String, ByVal name As String, ByVal apelido As String, ByVal Original_Id As Integer, ByVal Original_username As String, ByVal Original_password As String, ByVal Original_name As String, ByVal Original_apelido As String, ByVal Id As Integer) As Integer
            If (username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("username")
            Else
            ...
            If (Original_apelido Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_apelido")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_apelido,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal username As String, ByVal password As String, ByVal name As String, ByVal apelido As String, ByVal Original_Id As Integer, ByVal Original_username As String, ByVal Original_password As String, ByVal Original_name As String, ByVal Original_apelido As String) As Integer
            Return Me.Update(username, password, name, apelido, Original_Id, Original_username, Original_password, Original_name, Original_apelido, Original_Id)
        End Function
    End Class
